...
//
// The Original Code is uIniPreviewHandler.pas.
//
...
const
  GUID_IniPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0018}';

type
  TIniPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TIniPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynIniSyn1;
