...
//
// The Original Code is uCSharpPreviewHandler.pas.
//
...
const
  GUID_CSharpPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0005}';

type
  TCSharpPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TCSharpPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      Editor.RefreshSynHighlighter:=RefreshSynCSharpHighlighter;
      Editor.LoadTheme;
    end;
  except
    on E: Exception do
