...
//
// The Original Code is uEiffelPreviewHandler.pas.
//
...
const
  GUID_EiffelPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0001}';

type
  TEiffelPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TEiffelPreviewHandler.Create(AParent: TWinControl);
begin
