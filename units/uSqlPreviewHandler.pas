...
//
// The Original Code is uSqlPreviewHandler.pas.
//
...
const
  GUID_SqlPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0016}';

type
  TSQLPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TSQLPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynSQLSyn1;
