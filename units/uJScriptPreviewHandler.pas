...
//
// The Original Code is uJScriptPreviewHandler.pas.
//
...
const
  GUID_JScriptPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0008}';

type
  TJScriptPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TJScriptPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynJScriptSyn1;
