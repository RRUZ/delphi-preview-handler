...
//
// The Original Code is uPythonPreviewHandler.pas.
//
...
const
  GUID_PythonPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0013}';

type
  TPythonPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TPythonPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynPythonSyn1;
