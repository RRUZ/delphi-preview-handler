...
//
// The Original Code is uVBPreviewHandler.pas.
//
...
constructor TVBPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynVBSyn1;
      Editor.RefreshSynHighlighter:=RefreshSynVBHighlighter;
      Editor.LoadTheme;
    end;
  except
    on E: Exception do
