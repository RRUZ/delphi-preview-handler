...
//
// The Original Code is uVBScriptPreviewHandler.pas.
//
...
const
  GUID_VBScriptPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0010}';

type
  TVBScriptPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TVBScriptPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynVBScriptSyn1;
