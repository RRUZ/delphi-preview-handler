...
//
// The Original Code is uPerlPreviewHandler.pas.
//
...
const
  GUID_PerlPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0012}';

type
  TPerlPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TPerlPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynPerlSyn1;
