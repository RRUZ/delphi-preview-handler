...
//
// The Original Code is uPhpPreviewHandler.pas.
//
...
const
  GUID_PhpPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0009}';

type
  TPhpPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TPhpPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynPHPSyn1;
