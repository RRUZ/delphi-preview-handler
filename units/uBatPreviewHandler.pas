...
//
// The Original Code is uBatPreviewHandler.pas.
//
...
constructor TBatPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynBatSyn1;
