...
//
// The Original Code is uJavaPreviewHandler.pas.
//
...
const
  GUID_JavaPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0003}';

type
  TJavaPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TJavaPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynJavaSyn1;
      Editor.RefreshSynHighlighter:=RefreshSynJavaHighlighter;
      Editor.LoadTheme;
    end;
  except
    on E: Exception do
