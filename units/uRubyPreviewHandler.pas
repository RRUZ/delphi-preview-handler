...
//
// The Original Code is uRubyPreviewHandler.pas.
//
...
const
  GUID_RubyPreviewHandler: TGUID = '{B8961094-8033-4D5B-AAB3-A6BCC76E0014}';

type
  TRubyPreviewHandler = class(TBasePreviewHandler)
  public
...
constructor TRubyPreviewHandler.Create(AParent: TWinControl);
begin
  ...
  try
    ...
    begin
      ...
      //Editor.Visible:=True;
      Editor.SynEdit1.Highlighter:=Editor.SynRubySyn1;
